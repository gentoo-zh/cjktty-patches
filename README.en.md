...
- Default `CONFIG_FONT_CJK_32x32` off. The base patch ships an empty `font_cjk_32x32.h`, while the option had defaulted to on since 2021; builds therefore compiled 8 MiB of zeros into the kernel and reported success.
