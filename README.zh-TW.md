...
補丁以 [gentoo-zh/linux-cjktty](https://github.com/gentoo-zh/linux-cjktty) 為基礎；本倉庫新增的修正記錄於 [CHANGELOG.zh-TW.md](CHANGELOG.zh-TW.md)。
...
完整的版本記錄見 [CHANGELOG.zh-TW.md](CHANGELOG.zh-TW.md)。
